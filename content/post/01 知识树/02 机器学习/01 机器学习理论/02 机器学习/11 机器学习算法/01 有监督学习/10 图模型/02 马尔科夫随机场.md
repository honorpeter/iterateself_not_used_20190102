...
![mark](http://images.iterate.site/blog/image/180701/jEgfKk9j9g.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/4D2dJ9F0fh.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/Kdf0JL1b0E.png?imageslim)


其中 $Z^* =\sum_x \prod_{Q\in\mathcal{C}^*}\phi_Q(x_Q)$ 为规范化因子.例如图14.2中 $x = \{x_1,x_2,\cdots,x_6\}$ ,联合概率分布 $P(x)$ 定义为

![mark](http://images.iterate.site/blog/image/180701/Lle2If1k7l.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/62LmKB5D26.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/CH8km0Fd4I.png?imageslim)


对于图14.4,由式(14.2)可得联合概率

![mark](http://images.iterate.site/blog/image/180701/fk4mi3mkEg.png?imageslim)


基于条件概率的定义可得：


![mark](http://images.iterate.site/blog/image/180701/0h7jkLG5ce.png?imageslim)


由式(14.5)和(14.6)可知

![mark](http://images.iterate.site/blog/image/180701/HC6FLEfCHl.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/C2AIB3I5gC.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180701/hhFg3Aj0bK.png?imageslim)

$H_Q(x_Q)$ 是一个定义在变量 $x_Q$ 上的实值函数，常见形式为

![mark](http://images.iterate.site/blog/image/180701/7IAfef07fa.png?imageslim)
