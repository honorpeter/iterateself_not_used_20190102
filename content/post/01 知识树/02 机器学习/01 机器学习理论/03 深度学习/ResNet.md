...
![mark](http://images.iterate.site/blog/image/180728/C187jjjEAJ.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/DkA7eJ4ll7.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/5iLbgjJ9a2.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/K9ElgFjf5A.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/2L78L2IL68.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/484F5IHIec.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/EEgbhhHCFD.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/K8IFedD7Ia.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/LbG2ecJCIe.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/ejEGfDFi6d.png?imageslim)

当 b_l=1 时，该块为正常的残差块；当 b_l=0 时，上述公式为：


![mark](http://images.iterate.site/blog/image/180728/K391cm7AbK.png?imageslim)既然我们已经知道了 H_(l-1) 是 ReLU 的输出，而且这个输出结果已经是非负的，所以上述方程可简化为将输入传递到下一层的 identity 层：



![mark](http://images.iterate.site/blog/image/180728/f3jC5m5AI0.png?imageslim)

令 p_l 表示是第 l 层在训练中的生存概率，在测试过程中，我们得到：


![mark](http://images.iterate.site/blog/image/180728/0BCli9dhBL.png?imageslim)

作者将线性衰减规律应用于每一层的生存概率，他们表示，由于较早的层提取的低级特征会被后面的层使用，所以不应频繁丢弃较早的层。这样，规则就变成：


![mark](http://images.iterate.site/blog/image/180728/bdGHlK1mG9.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/lFBglEGmg8.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/7Hgjad6hEC.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/1ak2316Fde.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180728/209FgL7eia.png?imageslim)
