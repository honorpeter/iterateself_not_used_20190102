...
![mark](http://images.iterate.site/blog/image/180805/4EiDa79jIL.png?imageslim)

Fun 中老师讲了 kniect ，从深度图像中构建了骨骼模型，而且每一帧都从图像中单独检测到骨架，这样比较 robust。这个是kniect 的一个创新之处。

下面介绍一下常用的应用：

![mark](http://images.iterate.site/blog/image/180805/Ka8LilE0j0.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/Bmf6BCgG1H.png?imageslim)

ar 眼镜效果还是很不错的。google glass。
robotics 也是现在很火的，实际上很多年前就已经有了。aibo 就是典型的用 sift 算子，

![mark](http://images.iterate.site/blog/image/180805/cjkdH2B0b1.png?imageslim)

工业上的零件识别，
ocr 这个汉字的就很困难了，我们会介绍到如何识别车牌。<span style="color:red;">嗯，非常想知道。</span>


![mark](http://images.iterate.site/blog/image/180805/Hl3dCjBJj1.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/e0iiGlbJfh.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/kj5Ih75biL.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/gHlGH2h60d.png?imageslim)
