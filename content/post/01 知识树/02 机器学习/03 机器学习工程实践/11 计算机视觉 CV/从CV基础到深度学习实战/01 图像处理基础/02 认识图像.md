...
![mark](http://images.iterate.site/blog/image/180805/C2b07lk556.png?imageslim)

![mark](http://images.iterate.site/blog/image/180805/6FhI1Il0D7.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/44dCFj1J5m.png?imageslim)

opencv 是以图像的左上角开始存储，按行存储，是从0开始的，注意一下：matlab 是从 1 开始的。

下面是一个 rgb 图像在 opencv 中的存储位置：

![mark](http://images.iterate.site/blog/image/180805/50EGFmCBB1.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/fE6hgcHE2f.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/0AJ74Ggj1G.png?imageslim)

![mark](http://images.iterate.site/blog/image/180805/fbIj5AaJhb.png?imageslim)

![mark](http://images.iterate.site/blog/image/180805/bAbcfcGiDi.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/J1bJff2k9H.png?imageslim)

之前讲的构造函数都是浅拷贝。这个时候，对 m2 进行操作 m1 也会更改。

深拷贝：

![mark](http://images.iterate.site/blog/image/180805/kJjGialDKc.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180805/FAgbfD89Kc.png?imageslim)
