...
![mark](http://images.iterate.site/blog/image/180809/HdIC6e84ik.png?imageslim)

可是在真实的情况下，我们可能想找到不同尺度下的对应

![mark](http://images.iterate.site/blog/image/180809/3e1FmabHFc.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180809/ijj0B1EiBf.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180809/4ELgia0Ffc.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180809/J6L0hHa7gB.png?imageslim)


![mark](http://images.iterate.site/blog/image/180809/Lk0jklB8h9.png?imageslim)

DOG 是 LOG 的近似，画成 2D 的图像：

![mark](http://images.iterate.site/blog/image/180809/h5CC9Dchm8.png?imageslim)

在 DOG 里面，我们构造这样一个尺度空间，在三维空间上寻找极值，Detect maxima and minima of difference-of-Gaussian in scale space

![mark](http://images.iterate.site/blog/image/180809/LBk5ecIiBj.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180809/3lAdkE3I4B.png?imageslim)

然后 SIFT 里面构建了高斯金字塔，用不同的 $k\sigma$ 来模糊，模糊后做二倍的降采样，在模糊，在模糊，每一组叫做一个 octave。

![mark](http://images.iterate.site/blog/image/180809/aKIcDf1508.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180810/mK64Kd1gmF.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180810/GLK46KI2aB.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180810/93jClCdKEi.png?imageslim)

得到这样的图像，这样的图像在啊立体的空间中取极值，取到了这个极值他是离散的，在 SIFT 里面还要进行差值运算，这里面就不说了，用到的是一个 hession矩阵。

把边界点去掉，我们会得到这样的一些图像上的特征点：

![mark](http://images.iterate.site/blog/image/180810/I9dK21c9gd.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180810/4l75ak2f9h.png?imageslim)
