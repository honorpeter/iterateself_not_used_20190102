...
![set-encoding-in-notepad++](https://cdn.liaoxuefeng.com/cdn/files/attachments/001427719248811c5f9fd37acf54f6f93d7affbd80dd79b000)

如果`.py`文件本身使用UTF-8编码，并且也申明了`# -*- coding: utf-8 -*-`，打开命令提示符测试就可以正常显示中文：

![py-chinese-test-in-cmd](https://cdn.liaoxuefeng.com/cdn/files/attachments/0014277193240041efdda5a5de14f58a0879d8d4efcee66000)

### 格式化

最后一个常见的问题是如何输出格式化的字符串。我们经常会输出类似`'亲爱的xxx你好！你xx月的话费是xx，余额是xx'`之类的字符串，而xxx的内容都是根据变量变化的，所以，需要一种简便的格式化字符串的方式。

![py-str-format](https://cdn.liaoxuefeng.com/cdn/files/attachments/001389579690189985ca83044bd4aa7a80c47f9296a5c4e000/0)
