...
![mark](http://images.iterate.site/blog/image/180803/f197AA58H4.png?imageslim)
...
![mark](http://images.iterate.site/blog/image/180803/61AceDK34J.png?imageslim)
- 然后把分成的4 块中的每一个块分别作为前16位来进行查找，建倒排索引。

具体如下图所示：

![mark](http://images.iterate.site/blog/image/180803/AkAaHC1590.png?imageslim)
