...
![mark](http://images.iterate.site/blog/image/180708/KEmLc89gK5.jpg?imageslim)

![mark](http://images.iterate.site/blog/image/180708/Bikm46c97k.jpg?imageslim)
![mark](http://images.iterate.site/blog/image/180708/16bDl9kHD9.jpg?imageslim)
![mark](http://images.iterate.site/blog/image/180708/77ail6g1cf.jpg?imageslim)
![mark](http://images.iterate.site/blog/image/180708/FKmLH2DIfI.jpg?imageslim)

![mark](http://images.iterate.site/blog/image/180708/5D5GceAi6G.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/8G41hlj08c.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/Hk6iF8blEe.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/7acd9JF4h3.jpg?imageslim)
...
在组建一组尺度空间后，再组建下一组尺度空间，对上一组尺度空间的最后一幅图像进行二分之一采样，得到下一组尺度空间的第一幅图像，然后进行像建立第一组尺度空间那样的操作，得到第二组尺度空间，公式定义为
    ...
    ![mark](http://images.iterate.site/blog/image/180708/EldfEf46Gf.jpg?imageslim)
...
D(x,y,e) = ((G(x,y,ke) - G(x,y,e)) \* I(x,y) = L(x,y,ke) - L(x,y,e)
    ...
    ![mark](http://images.iterate.site/blog/image/180708/iEB2ak2md9.jpg?imageslim)
...
3. 再以金字塔图像中第二层中的2倍尺度图像（相对于该层第一幅图像的2倍尺度）以2倍像素距离进行下采样来得到金字塔图像的第三层中的第一幅图像，对该图像采用不同尺度因子的高斯核进行卷积，以获得金字塔图像中第三层的一组图像。这样依次类推，从而获得了金字塔图像的每一层中的一组图像，如下图所示：
    ![mark](http://images.iterate.site/blog/image/180708/akLc7k55GD.jpg?imageslim)
4. 对上图得到的每一层相邻的高斯图像相减，就得到了高斯差分图像，如下述第一幅图所示。下述第二幅图中的右列显示了将每组中相邻图像相减所生成的高斯差分图像的结果，限于篇幅，图中只给出了第一层和第二层高斯差分图像的计算（下述俩幅图统称为图2）：

    ![mark](http://images.iterate.site/blog/image/180708/2IeGD5jm8K.jpg?imageslim)

    ![mark](http://images.iterate.site/blog/image/180708/ig3eJ6dKK9.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/0La8cdk0G8.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/cadiGIijKj.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/b69g5l4d3L.jpg?imageslim)
...
![mark](http://images.iterate.site/blog/image/180708/C71fd5JECa.jpg?imageslim)
