...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/k1GKD11K3h.png?imageslim)

搭建高长宽分别为K × 2^N × 1的墙，不能翻转、旋转（其中，0<=N<=1024，1<=K<=4）

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/3928d3bcjE.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/4Aj63fGCKk.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/IEbJ3HKdDD.png?imageslim)

OK，回到正题。下文使用的图示说明(所有看到的都是横切面)：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/BBfjkaGhdH.png?imageslim)

首先说明“？方块”的作用

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/BeGeLc50HF.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/fiFhIBaAk1.png?imageslim)

下面演示当n=1,k=2的算法过程（7种情况）：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/7m5mliklKa.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/DFme9lLHlL.png?imageslim)

图 2-1

上图2-1中：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/20kcA3LIaL.png?imageslim)
表示，左边墙的所有堆放方案数 * 右边墙所有堆放方案数 = 2 * 2 = 4

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/hL849mfC8A.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/l2ikhG3EKK.png?imageslim)

图 2-2

再从分解的结果中，挑选一组进行分解演示：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/7i7aFmmbF1.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/JLKb0IAHIJ.png?imageslim)

图2-4

根据上面的分解的一个中间结果，再进行分解，如下：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/b6480eBDeC.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/i4dI7lEj8f.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/5ce4ic3IJ1.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/hjJBHB0C27.png?imageslim)

即：

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/fj0J9kEAgJ.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/BIej0404jf.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/gclLm2E7b0.png?imageslim)

它用方程表示即为 f(2,3,2,5)，怎么得来的呢？其实还是又回到了上文2.1.3节中，当n=2，k=3 时（下图即为上文2.1.3节中的图2-5和图2-6）

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/hEA34DC32b.png?imageslim)

![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/k5B4eg4i5i.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/kgaGjjj4im.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/24GGCf79C5.png?imageslim)
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/KA5FdK5kjD.png?imageslim)

当第i行被这样的木块![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/90gG1b204J.png?imageslim)或这样的木块![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/9d7IhImG9K.png?imageslim)占据时，其各自对应的state值分别为：
...
![mark](http://pacdb2bfr.bkt.clouddn.com/blog/image/180708/KDg4KjgBeg.png?imageslim)
